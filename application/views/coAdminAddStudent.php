<?php $this->load->view("templates/userHeader"); ?>
    ...
    <?php echo form_open("users/coAdminCreateStudent", ['class' => 'form-horizontal']); ?>
    <div class="container">
      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card border-0 shadow rounded-3 my-5">
          <div class="card-body p-4 p-sm-5">
            <h5 class="card-title text-center mb-5 fw-regular fs-5">ADD STUDENT</h5>
            <form>
              <div class="row">
                  <div class="col-md-12">
              ...
              <div class="form-floating mb-3">
                <input class="form-control" name="studentname" id="floatingInput" type="text" value="<?php echo set_value('studentname') ?>" placeholder="Username" autofocus="autofocus" required>
                <?php echo form_error('studentname','<div class="text-danger">','</div>'); ?>
                <label for="floatingInput">Student Name</label>
              </div>

              <div class="form-floating mb-3">
                <input class="form-control" name="email" id="floatingInput" type="email" value="<?php echo set_value('email') ?>" placeholder="Email" required>
              ...
              <div class="form-floating mb-3">
                <input class="form-control" name="course" id="floatingInput" type="text" value="<?php echo set_value('course') ?>" placeholder="Course" autofocus="autofocus" required>
