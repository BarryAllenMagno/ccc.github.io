            ...
            <div class="row">
             ...
             <div class="row">
              ...
              <div class="row">
                 ...
                 <button type="submit" class="btn btn-primary" style="margin: 0px 0px 0px 15.4px;">ADD</button>
                 <?php echo anchor("admin/dashboard", "CANCEL",['class'=>'btn btn-primary','style' => ('margin:0px 0px 0px 3px')]);?>
    </div>
    <br>
        <?php echo form_close();?>
